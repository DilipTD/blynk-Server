...
![Dashboard settings](https://github.com/deepu083/blynk-server/blob/master/docs/overview/dash_settings.png)
...
**Download latest server build [here](https://github.com/deepu083/blynk-server/releases).**

[![GitHub version](https://img.shields.io/github/release/deepu083/blynk-server.svg)](https://github.com/deepu083/blynk-server/releases/latest)
[![GitHub download](https://img.shields.io/github/downloads/deepu083/blynk-server/total.svg)](https://github.com/deepu083/blynk-server/releases/latest)
[ ![Build Status](https://travis-ci.org/deepu083/blynk-server.svg?branch=master)](https://travis-ci.org/blynkkk/blynk-server)
...
Find example [here](https://github.com/deepu083/blynk-server/blob/master/server/notifications/email/src/main/resources/mail.properties).
...
+ Download Blynk server jar file (or manually copy it to Raspberry Pi via ssh and scp command): 
        ...
        wget "https://github.com/deepu083/blynk-server/releases/download/v0.41.16/server-0.41.16-java8.jar"
...
You can also use [this](https://github.com/deepu083/blynk-server/tree/master/scripts/win) script to run server.
...
![Custom server icon](https://github.com/deepu083/blynk-server/blob/master/docs/login.png)
![Server properties menu](https://github.com/deepu083/blynk-server/blob/master/docs/custom.png)
...
Example could be found [here](https://github.com/deepu083/blynk-server/blob/master/server/core/src/main/resources/server.properties).
...
+ 100 Req/sec rate limit per user. You also may want to extend this limit on [hardware side](https://github.com/deepu083/blynk-library/blob/f4e132652906d63d683abeed89f5d6ebe369e37a/Blynk/BlynkConfig.h#L42).
...
![Administration UI](https://github.com/deepu083/blynk-server/blob/master/docs/admin_panel.png)
...
#### 3. Download Blynk DB script
        ...
        wget https://raw.githubusercontent.com/deepu083/blynk-server/master/server/core/src/main/resources/create_schema.sql
        wget https://raw.githubusercontent.com/deepu083/blynk-server/master/server/core/src/main/resources/reporting_schema.sql
...
If you connect hardware with [USB script](https://github.com/deepu083/blynk-library/tree/master/scripts) you have to provide an option '-s' pointing to "common name" (hostname) you did specified during certificate generation.
...
Command and Status definitions: [BlynkProtocolDefs.h](https://github.com/deepu083/blynk-library/blob/7e942d661bc54ded310bf5d00edee737d0ca44d7/src/Blynk/BlynkProtocolDefs.h)
...
[Possible response codes](https://github.com/deepu083/blynk-server/blob/master/server/core/src/main/java/cc/blynk/server/core/protocol/enums/Response.java#L12).
[Possible command codes](https://github.com/deepu083/blynk-server/blob/master/server/core/src/main/java/cc/blynk/server/core/protocol/enums/Command.java#L12)

Message Id and Length are [big endian](http://en.wikipedia.org/wiki/Endianness#Big-endian).
Body has a command-specific format.

## Licensing
[GNU GPL license](https://github.com/deepu083/blynk-server/blob/master/license.txt)
